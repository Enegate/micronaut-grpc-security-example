...
@GrpcInterceptor
public class GreeterServiceInterceptor implements ServerInterceptor, Ordered {

    private static final Logger LOG = LoggerFactory.getLogger(GreeterServiceInterceptor.class);
